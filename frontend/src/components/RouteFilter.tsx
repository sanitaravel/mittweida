  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[80vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-sandstone/20">
          ...
          <div>
            ...
            <div className="space-y-2">
              <input
                ...
                max="120"
                step="15"
                value={localFilters.maxDuration || 120}
                onChange={(e) =>
                  setLocalFilters((prev) => ({
                    ...prev,
        ...
        {/* Footer */}
        <div className="flex gap-3 p-6 border-t border-sandstone/20">
